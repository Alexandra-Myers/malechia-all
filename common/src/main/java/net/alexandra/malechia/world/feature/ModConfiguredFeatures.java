...
public class ModConfiguredFeatures {
    ...
    static{
        ALLIAN_ORES = List.of(OreFeatureConfig.createTarget(END_STONE, ModBlocks.ALLIAN_ORE.get().getDefaultState()));
        ALLIAN_ORE = ConfiguredFeatureUtil.register( "ore_allian", Feature.ORE, new OreFeatureConfig(ALLIAN_ORES, 6, 0.6F));

        ALOTIC_ORES = List.of(OreFeatureConfig.createTarget(STONE_ORE_REPLACEABLES, ModBlocks.ALOTIC_ORE.get().getDefaultState()), OreFeatureConfig.createTarget(DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_ALOTIC_ORE.get().getDefaultState()));
        ALOTIC_ORE = ConfiguredFeatureUtil.register("ore_alotic", Feature.ORE, new OreFeatureConfig(ALOTIC_ORES, 8));

        AURAUM_ORES = List.of(OreFeatureConfig.createTarget(STONE_ORE_REPLACEABLES, ModBlocks.AURAUM_ORE.get().getDefaultState()), OreFeatureConfig.createTarget(DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_AURAUM_ORE.get().getDefaultState()));
        AURAUM_ORE = ConfiguredFeatureUtil.register("ore_auraum", Feature.ORE, new OreFeatureConfig(AURAUM_ORES, 6));

        CHRYON_ORES = List.of(OreFeatureConfig.createTarget(STONE_ORE_REPLACEABLES, ModBlocks.CHRYON_ORE.get().getDefaultState()), OreFeatureConfig.createTarget(DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_CHRYON_ORE.get().getDefaultState()));
        CHRYON_ORE = ConfiguredFeatureUtil.register("ore_chryon", Feature.ORE, new OreFeatureConfig(CHRYON_ORES, 8));

        ERETH_ORES = List.of(OreFeatureConfig.createTarget(STONE_ORE_REPLACEABLES, ModBlocks.ERETH_ORE.get().getDefaultState()), OreFeatureConfig.createTarget(DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_ERETH_ORE.get().getDefaultState()));
        ERETH_ORE = ConfiguredFeatureUtil.register("ore_ereth", Feature.ORE, new OreFeatureConfig(ERETH_ORES, 8));

        HALORIUM_ORES = List.of(OreFeatureConfig.createTarget(STONE_ORE_REPLACEABLES, ModBlocks.HALORIUM_ORE.get().getDefaultState()), OreFeatureConfig.createTarget(DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_HALORIUM_ORE.get().getDefaultState()));
        HALORIUM_ORE = ConfiguredFeatureUtil.register("ore_halorium", Feature.ORE, new OreFeatureConfig(HALORIUM_ORES, 8));

        LITRIUM_ORES = List.of(OreFeatureConfig.createTarget(STONE_ORE_REPLACEABLES, ModBlocks.LITRIUM_ORE.get().getDefaultState()), OreFeatureConfig.createTarget(DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_LITRIUM_ORE.get().getDefaultState()));
        LITRIUM_ORE = ConfiguredFeatureUtil.register("ore_litrium", Feature.ORE, new OreFeatureConfig(LITRIUM_ORES, 8));

        LOCRONITE_ORES = List.of(OreFeatureConfig.createTarget(STONE_ORE_REPLACEABLES, ModBlocks.LOCRONITE_ORE.get().getDefaultState()), OreFeatureConfig.createTarget(DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_LOCRONITE_ORE.get().getDefaultState()));
        LOCRONITE_ORE = ConfiguredFeatureUtil.register("ore_locronite", Feature.ORE, new OreFeatureConfig(LOCRONITE_ORES, 4));

        MYCRONIUM_ORES = List.of(OreFeatureConfig.createTarget(STONE_ORE_REPLACEABLES, ModBlocks.MYCRONIUM_ORE.get().getDefaultState()), OreFeatureConfig.createTarget(DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_MYCRONIUM_ORE.get().getDefaultState()));
        MYCRONIUM_ORE = ConfiguredFeatureUtil.register("ore_mycronium", Feature.ORE, new OreFeatureConfig(MYCRONIUM_ORES, 8));

        QUARITE_ORES = List.of(OreFeatureConfig.createTarget(STONE_ORE_REPLACEABLES, ModBlocks.QUARITE_ORE.get().getDefaultState()), OreFeatureConfig.createTarget(DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_QUARITE_ORE.get().getDefaultState()));
