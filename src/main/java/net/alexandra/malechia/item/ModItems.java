...
public class ModItems extends ModRegistries {
    ...
    public static final RegistrySupplier<ToolItem> MALECHIA_SWORD = ITEMS.register("malechia_sword",
    ...
    public static final RegistrySupplier<ToolItem> ENHANCED_MALECHIA_SWORD = ITEMS.register("enhanced_malechia_sword",
            () -> new EnhancedSwordItem(MalechiaToolMaterials.MALECHIA, 3, -2F, 1, new Item.Settings().rarity(Rarity.EPIC).fireproof()));
    public static final RegistrySupplier<ToolItem> MALECHIA_SHOVEL = ITEMS.register("malechia_shovel",
    ...
    public static final RegistrySupplier<ToolItem> ENHANCED_MALECHIA_SHOVEL = ITEMS.register("enhanced_malechia_shovel",
            () -> new EnhancedShovelItem(MalechiaToolMaterials.MALECHIA, 2.5F, -2.5F, 1, new Item.Settings().rarity(Rarity.EPIC).fireproof()));
    public static final RegistrySupplier<ToolItem> MALECHIA_PICKAXE = ITEMS.register("malechia_pickaxe",
    ...
    public static final RegistrySupplier<ToolItem> ENHANCED_MALECHIA_PICKAXE = ITEMS.register("enhanced_malechia_pickaxe",
            () -> new EnhancedPickaxeItem(MalechiaToolMaterials.MALECHIA, 2, -2.3F, 1,new Item.Settings().rarity(Rarity.EPIC).fireproof()));
    public static final RegistrySupplier<ToolItem> MALECHIA_AXE = ITEMS.register("malechia_axe",
    ...
    public static final RegistrySupplier<ToolItem> ENHANCED_MALECHIA_AXE = ITEMS.register("enhanced_malechia_axe",
            () -> new EnhancedAxeItem(MalechiaToolMaterials.MALECHIA, 4, -2.7F, 1, new Item.Settings().rarity(Rarity.EPIC).fireproof()));
    public static final RegistrySupplier<ToolItem> MALECHIA_HOE = ITEMS.register("malechia_hoe",
    ...
    public static final RegistrySupplier<ToolItem> ENHANCED_MALECHIA_HOE = ITEMS.register("enhanced_malechia_hoe",
            () -> new EnhancedHoeItem(MalechiaToolMaterials.MALECHIA, 1, 1F, 1, new Item.Settings().rarity(Rarity.EPIC).fireproof()));
    ...
    public static final RegistrySupplier<MalechiaBowItem> ENHANCED_MALECHIA_BOW = ITEMS.register("enhanced_malechia_bow",
            () -> new EnhancedMalechiaBowItem(1, new Item.Settings().rarity(Rarity.EPIC).maxDamage(5000)));
    ...
    protected static RegistrySupplier<ToolItem> registerToolItem(String name, ToolItem item) {
        return ITEMS.register(new Identifier(MOD_ID, name), () -> item);
    }
    protected static RegistrySupplier<ArmorItem> registerArmorItem(String name, ArmorItem item) {
        return ITEMS.register(new Identifier(MOD_ID, name), () -> item);
    }
    private static RegistrySupplier<BowItem> registerBowItem(String name, BowItem item) {
        return ITEMS.register(new Identifier(MOD_ID, name), () -> item);
    }
    protected static RegistrySupplier<MalechiaBowItem> registerMalechiaBowItem(String name, MalechiaBowItem item) {
        return ITEMS.register(new Identifier(MOD_ID, name), () -> item);
    }
