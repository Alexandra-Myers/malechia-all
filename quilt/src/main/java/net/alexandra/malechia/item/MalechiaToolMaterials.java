...
public enum MalechiaToolMaterials implements ToolMaterial {
    BOSS(4, 6666, 9.0F, 4.0F, 40, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{ModItems.BOSS_ESSENCE_IRON_INGOT.get()});
    }),
	UNKNOWN(10, 200000, 200F, 20.0F, 500, () -> {
		return Ingredient.ofItems(new ItemConvertible[]{ModItems.EMPOWERED_STICK.get()});
	}),
